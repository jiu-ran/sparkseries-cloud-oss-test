package com.sparkseries.common.enums;
...
public enum StorageTypeEnum {
     ...
     * 阿里云
     */
    OSS("oss", 1, CloudConfigDTO.OssGroup.class),

    /**
     * 腾讯云
     */
    COS("cos", 2, CloudConfigDTO.CosGroup.class),

    /**
     * 七牛云
     */
    KODO("kodo", 3, CloudConfigDTO.KodoGroup.class),

    /**
     * MinIO
     */
    MINIO("minio", 4, CloudConfigDTO.MinioGroup.class),

    /**
     * 本地储存
     */
    LOCAL("local", 5, CloudConfigDTO.LocalGroup.class);
    ...
    StorageTypeEnum(String key, int value, Class<?> group) {
        this.key = key;
        this.value = value;
        this.group = group;
    }
