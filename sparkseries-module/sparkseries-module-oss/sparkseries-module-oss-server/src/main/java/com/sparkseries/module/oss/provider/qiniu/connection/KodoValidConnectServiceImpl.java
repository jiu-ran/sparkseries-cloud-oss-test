...
public class KodoValidConnectServiceImpl implements ValidConnectService {
    ...
    public boolean connectTest(String accessKey, String secretKey, String bucketName) {
        ...
        try {
            ...
            throw new OssException("accessKey/secretKey 无效");
        }
        ...
        try {
            ...
            throw new OssException("bucket不存在 请输入正确的bucket");
        }
        ...
        try (InputStream inputStream = new ByteArrayInputStream(testContent)) {
            ...
            throw new OssException("该API密钥对该bucket 不具备写权限");
        } catch (IOException e) {
        ...
        try {
            ...
            throw new OssException("该API密钥对该bucket 不具备读权限");
        }
        ...
        try {
            ...
            throw new OssException("该API密钥对该bucket 不具备删除权限");
        }
