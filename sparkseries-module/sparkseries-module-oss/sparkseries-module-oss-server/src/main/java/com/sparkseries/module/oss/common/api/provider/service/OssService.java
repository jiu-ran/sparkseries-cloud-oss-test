...
public interface OssService {
     ...
     * @return 操作成功返回 true，失败返回 false
     */
    boolean createFolder(String absolutePath, VisibilityEnum visibility, String userId);
     ...
     * @return 下载文件的url路径
     */
    String downLoad(String absolutePath, VisibilityEnum visibility);
     ...
     * @return 操作成功返回 true，失败返回 false
     */
    boolean moveFile(String sourceAbsolutePath, String targetAbsolutePath, VisibilityEnum visibility, String userId);
